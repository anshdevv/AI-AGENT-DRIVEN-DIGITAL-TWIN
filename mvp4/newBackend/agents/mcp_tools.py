    ...
    try:
        ...
        if response.data:
            ...
            return (
                ...
                f"  General allergies  : {h.get('general_allergies') or 'None reported'}\n"
                f"  Family history     : {h.get('family_history') or 'None reported'}\n"
                f"  Smoking            : {h.get('smoking_status') or 'None reported'}\n"
                f"  Menstrual history  : {h.get('menstrual_history') or 'None reported'}\n"
                f"  LMP date           : {h.get('lmp_date') or 'None reported'}\n"
                f"  Pregnancy status   : {h.get('pregnancy_status') or 'None reported'}\n"
                f"  Obstetric history  : {h.get('obstetric_history') or 'None reported'}\n"
                f"  Fall history       : {h.get('fall_history') or 'None reported'}\n"
                f"  Vaccination status : {h.get('vaccination_status') or 'None reported'}\n"
